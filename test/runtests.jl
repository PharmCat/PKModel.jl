...
# !!! Main.UserApp is configured as an alias for Main.PKModel and you might encounter it in some tests
using Main.PKModel, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "PKModel tests" begin
  @includetests ARGS
end
